...
class SalesController {
  ...
  async getSalesEmployees(req, res) {
    try {
      ...
      return response.success(
        res,
        "Sotuvchilar muvaffaqiyatli olindi",
        salesEmployees
      );
    } catch (error) {
      ...
      return response.serverError(
        res,
        "Xodimlarni olishda server xatosi",
        error
      );
    }
  }
    ...
    try {
      ...
      if (!employee) {
        ...
        return response.notFound(
          res,
          "Sotuvchi topilmadi yoki bo'lim noto'g'ri"
        );
      }
  ...
  async getAllPlans(req, res) {
    try {
      ...
      return response.serverError(
        res,
        "Planlarni olishda server xatosi",
        error
      );
    }
  }
  ...
  async updatePlan(req, res) {
    try {
      ...
      return response.success(
        res,
        "Plan muvaffaqiyatli yangilandi",
        updatedPlan
      );
    } catch (error) {
